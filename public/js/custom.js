...
/* Active current link on click*/

$(document).ready(function(){
   // $('#forruneats-ul li:nth-child(1) a').addClass('current_page_item');
    $('#forruneats-ul a').click(function(e) {
        $('#forruneats-ul a').removeClass('current_page_item');
...
$(document).ready(function() {
    ...
    if (window.matchMedia('(max-width: 767px)').matches) {
        $('.sec-mobiles').each(function () {
            $(this).insertBefore($(this).prev('.sec-txt'));
        });
    } else {
        $('.sec-txt').each(function () {
            $(this).insertBefore($(this).prev('.sec-mobiles'));
        });
    }
});
