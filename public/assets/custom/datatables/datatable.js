    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    // see reference: https://datatables.net/examples/basic_init/dom.html
                    ...
                    "language": { // language settings
                        ...
                        //"infoEmpty": "No records found to show", // original
                        "infoEmpty": "", // 
                        //"emptyTable": "No data available in table", // original
            ...
            if ( typeof options.custom !== 'undefined' ) {
                if ( typeof options.custom.noInfo != 'undefined' && options.custom.noInfo )
                    tableOptions.dataTable.language.info = "";
            }

            //tableOptions.dataTable.bFilter = false;
            //tableOptions.dataTable.bInfo = false;
