...
@section('content')
    ...
    <div class="card-content">
      <div class="card-body">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('password.request') }}" aria-label="{{ __('Reset Password') }}" novalidate>
            @csrf
          ...
          <button type="submit" class="btn btn-outline-primary btn-lg btn-block"><i class="ft-unlock"></i> {{ __('Reset Password') }}</button>
        </form>
      </div>
    </div>
