        ...
        <div class="card-content collapse show">
          <div class="card-body">
            {!!
                ...
                ->addColumn('Degree', 'degree_name', 200, true, ['type'=>'text-field'])
                ...
                //->addColumn('Degree', 'degree_name', 100, true, ['type'=>'text-field' ])
                //->addColumn('Major', 'majors_name', 100, true, ['type'=>'text-field' ])
  ...
  <script type="text/javascript">
    ...
    xGrid.onLoad( function() {
        ...
        $('.grid-action-archive').on('click', function (e) {
            e.preventDefault();
            var $this = $(this);
            app.confirm('Are you sure to archive ' + $this.data('degree_name') + "?", function() {
