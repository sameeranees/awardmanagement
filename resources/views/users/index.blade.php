        ...
        <div class="card-content collapse show">
          <div class="card-body">
            {!!
                ...
                ->addColumn('Employee ID', 'id', 100, true, ['type'=>'text-field'])
                ->addColumn('Name', 'name', 300, true, ['type'=>'text-field'])
                ->addColumn('Email', 'email', 500, true, ['type'=>'text-field' ])
  ...
  <script type="text/javascript">
    ...
    xGrid.onLoad( function() {
        ...
        $('.grid-action-archive').on('click', function (e) {
            e.preventDefault();
            var $this = $(this);
            app.confirm('Are you sure to archive ' + $this.data('name') + "?", function() {
